...
export default function Instructor() {
  ...
  const [instructorData, setInstructorData] = useState([])      // ← empty array by default
  ...
  useEffect(() => {
    ;(async () => {
      ...
      try {
        ...
        setInstructorData(instructorApiData || [])     // fallback to []
        setCourses(result || [])
      } catch (error) {
  ...
  // Safe calculations — use empty array if null/undefined
